...
const AgregarFactura = () => {
    ...
    const clickSubmit =(event)=>{
        ...
        insertObject('Factura', { sNombre,aEtiqueta,dFechaPublicacion,
    ...
    const agregarFacturaForm = () => (
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                <label className="text-muted">Ingresar link de la Factura: </label>
    ...
    const mostrarFunciona = () => (
        ...
        style={{display: FacturaCreado ? '':'none'}}>
            <h4>{`${FacturaCreado} se ha creado exitosamente `}</h4>
        </div>
    );
